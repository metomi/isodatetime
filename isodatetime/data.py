...
class TimePoint(object):
    ...
    def get_smallest_missing_property_name(self):
        ...
        if not self.truncated:
            return None
        prop_dict = self.get_truncated_properties()
        attr_keys = ["year_of_century", "year_of_decade", "month_of_year",
                     "week_of_year", "day_of_year", "day_of_month",
                     "day_of_week", "hour_of_day", "minute_of_hour",
                     "second_of_minute"]
        # Note - may be an issue here. 'year_of_century' is not
        # really the next largest property from 'year_of_decade',
        # it should be something like 'decade_of_century'.
