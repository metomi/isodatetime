...
_DATE_TRANSLATE_INFO = [
    ...
    (r"CC", r"(?P<century>\\d\\d)",
     "%(century)02d", "century"),
    (r"YY", r"(?P<year_of_century>\\d\\d)",
     "%(year_of_century)02d", "year_of_century"),
    (r"MM", r"(?P<month_of_year>\\d\\d)",
     "%(month_of_year)02d", "month_of_year"),
    (r"DDD", r"(?P<day_of_year>\\d\\d\\d)",
     "%(day_of_year)03d", "day_of_year"),
    (r"DD", r"(?P<day_of_month>\\d\\d)",
     "%(day_of_month)02d", "day_of_month"),
    (r"Www", r"W(?P<week_of_year>\\d\\d)",
     "W%(week_of_year)02d", "week_of_year"),
    (r"D", r"(?P<day_of_week>\\d)",
     "%(day_of_week)01d", "day_of_week"),
    (r"z", r"(?P<year_of_decade>\\d)",
...
_TIME_TRANSLATE_INFO = [
    (r"(?<=^hh)mm", r"(?P<minute_of_hour>\\d\\d)",
     "%(minute_of_hour)02d", "minute_of_hour"),
    (r"(?<=^hh:)mm", r"(?P<minute_of_hour>\\d\\d)",
     "%(minute_of_hour)02d", "minute_of_hour"),
    (r"(?<=^-)mm", r"(?P<minute_of_hour>\\d\\d)",
     "%(minute_of_hour)02d", "minute_of_hour"),
    (r"^hh", r"(?P<hour_of_day>\\d\\d)",
...
_TIME_ZONE_TRANSLATE_INFO = [
    (r"mm", r"(?P<time_zone_minute>\\d\\d)",
     "%(time_zone_minute_abs)02d", "time_zone_minute_abs"),
    (r"mm", r"(?P<time_zone_minute>\\d\\d)",
     "%(time_zone_minute_abs)02d", "time_zone_minute_abs"),
    (r"hh", r"(?P<time_zone_hour>\\d\\d)",
